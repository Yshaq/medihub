...
urlpatterns = [
    ...
    path('myappointments/<int:id>',views.myappointmentdetails,name='my_appointment_detail'),
    path('myappointments/<int:id>/cancel', views.appointmentCancelView, name='patient-cancel-appointment'),
